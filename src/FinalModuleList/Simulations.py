...
"""
Module that contains classes and functions for simulating networks or other 
data.
...
class Yule:
    ...
    def __init__(self, 
        ...
        Raises:
            BirthDeathSimulationError: If something goes wrong simulating networks.
        """
        # set birth rate
        ...
        if n is not None:
            ...
            if time is None:
                raise BirthDeathSimulationError("If you do not provide a value for the\
    ...
    def _event(self, network : Network) -> int: 
        ...
        Returns: (int) 0 if success, -1 if no more events can happen.      
        """
    ...
    def generate_networks(self, num_networks : int) -> list[Network]:
        ...
        Outputs: (list[Network]) the array of generated networks. 
...
class CBDP:
    ...
    def set_n(self, value : int) -> None:
        ...
        """
        if value < 2:
            raise BirthDeathSimulationError("Generated trees must have 2 or more taxa")
        self.N = value
    ...
    def set_sample(self, value : float) -> None:
        ...
        Raises:
            BirthDeathSimulationError: if the provided value is not in the right range
        """
    ...
    @staticmethod
    def _connect(index : int, nodes : list[Node]) -> Edge | None:
        """
