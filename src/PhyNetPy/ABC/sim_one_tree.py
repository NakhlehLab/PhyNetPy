...
sub_dist = elfi.Prior(scipy.stats.uniform, .2, .8) # prior distribution for sub
...
for i in range(0,100):
    ...
    t = growtree.gen_tree(b = birth, d = death, s = s_drawn, branch_info = 1, seq_length = 100, goal_leaves=32, sampling_rate=0.01)
    print(growtree.tree_height(t))
    print("number of leaves", growtree.tree_nleaf(t))
